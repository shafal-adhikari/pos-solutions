...
function AddPurchaseOrder({ editClicked, setIsAddClicked, setIsEditClicked }) {
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch({
      type: "GET_ALL_PURCHASE_ORDER_ADD_SECTION_REQUEST",
    });
  }, []);
  const {
    purchaseSectionList,
  ...
  useLayoutEffect(() => {
    if (editData && editClicked) {
      form.setFields([
        ...
        {
          name: "ShippingDate",
          value: dayjs(editData?.shippingDate, dateFormat),
        },
        {
          name: "DeliveryDate",
          value: dayjs(editData?.deliveryDate, dateFormat),
        },
        {
      ...
      setDeliveryAddress(() => {
        return {
          ...editData?.deliveryDetails,
          addressLocation: editData?.deliveryDetails?.fullAddress,
        };
      });
    }
  ...
  useLayoutEffect(() => {
    if (taxExclusiveInclusives) {
      ...
      form.setFieldValue("PurchaseOrderNumber", purchaseOrderNumber);
    }
  }, [taxExclusiveInclusives, purchaseOrderNumber]);
  ...
  const submitHandler = (values, pOrderNum) => {
    if (!deliveryAddress.addressLocation) {
      return;
    }
    ...
    const body = {
      ...
      PurchaseOrderNumber: pOrderNum ? pOrderNum : values.PurchaseOrderNumber,
      ShippingDate:
        dayjs(values.ShippingDate)
  ...
  return (
    <>
                      ...
                      <table className="table">
                        <tbody>
                          <tr>
                            <th className="text-left">Subtotal:</th>
                            <td className="text-right">
                              {typeof totalData?.subTotal == "number"
                          ...
                          <tr>
                            <th className="text-left">Tax Amount:</th>
                            <td className="text-right">
                              {typeof totalData?.taxAmount == "number"
                  ...
                  <div className="col-md-12">
                    <div className=" pt-0">
                      ...
                      <a
                        ...
                        href="#purchasedelivery"
                        role="button"
                        aria-expanded="false"
                        aria-controls="purchasedelivery"
                        className="advanced collapsed font-weight-bold"
                      >
                        Delivery Details <i className="fa fa-angle-down" />
                      </a>
                      <div>
                        {!deliveryAddress.addressLocation && saveClicked && (
                          <span style={{ color: "#ff4d4e" }}>
                            Please add delivery location
                          </span>
                        )}
                      </div>
                      <div className="collapse" id="purchasedelivery">
                        <div className="form-group">
                          <div className="">
                            <div className="row">
                              <div className="col-md-5">
                                <div className="card  h-100 border-light  bg-light shadow">
                                      ...
                                      <p className="mb-0 font-weight-bold">
                                        ...
                                        <span>
                                          ...
                                          <a
                                            ...
                                            data-target="#deliverModalCenter"
                                          >
      ...
      <AddDeliveryAddress
        ...
        setIsOpen={setDeliveryModalOpen}
      />
      <SendForApproval
