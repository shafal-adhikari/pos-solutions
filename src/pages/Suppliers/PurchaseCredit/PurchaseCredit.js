...
import AddPurchaseCredit from "./AddPurchaseCredit";
...
function PurchaseCredit() {
  ...
  useEffect(() => {
    dispatch({
      type: "GET_ALL_PURCHASE_NOTE_STATUS_REQUEST",
    });
  }, []);
  const {
    purchaseOrderStatus,
  ...
  useEffect(() => {
    if (selectedStatus) {
      dispatch({
        type: "GET_ALL_PURCHASE_CREDIT_REQUEST",
        payload: {
          Page: 1,
          PageSize: 10,
          SearchKeywords: "",
                    ...
                    <div className="card-body">
                      <div className="table_card d-flex justify-content-between">
                        <div className="table_btn mb-3 d-flex">
                          ...
                          >
                            Add New Purchase Credit Note
                          </a>
                          {bulkSelected.length > 0 && (
                            <Popconfirm
                              onConfirm={() => {
                                dispatch({
                                  type: "DELETE_PURCHASE_CREDIT_REQUEST",
                                    ...
                                    <tr key={purchaseOrder.id}>
                                      ...
                                      <td>
                                        <a
                                          onClick={() => {
                                            dispatch({
                                              type: "EDIT_PURCHASE_CREDIT_REQUEST",
                                        ...
                                        >
                                          {
                                            purchaseOrder.purchaseCreditNoteNumber
                                          }
                                        </a>
                                      </td>
                                      <td>{purchaseOrder.supplierName}</td>
                                      <td>{purchaseOrder.postingDate}</td>
