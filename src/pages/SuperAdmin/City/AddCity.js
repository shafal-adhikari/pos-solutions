...
function AddCity({ isOpen, setOpen, isEditClicked }) {
  ...
  useEffect(() => {
    if (!isEditClicked && countryList) {
      ...
      form.setFieldValue("CityAddViewModel", [
        {
          id: "",
          name: "",
          isActive: true,
    ...
    if (isEditClicked && editData) {
      form.setFields([
        ...
        },
        {
          ...
          value: editData.cityAddViewModel,
        },
      ]);
    }
          ...
          <Form form={form} onFinish={cityAddHandler}>
            <div className="contact_form categoryField">
              <div className="row">
                ...
                <Form.List name="CityAddViewModel">
                  {(fields, { add, remove }) => (
                    <>
